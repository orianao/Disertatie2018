...
if __name__ == '__main__':
	...
	print(clf.feature_importances_, accuracy_score(clf.predict(np.stack( recordingsDF[ 'samples' ].values, axis=0 )), recordingsDF['label'].values))
	print(confusion_matrix(clf.predict(np.stack( recordingsDF[ 'samples' ].values, axis=0 )), recordingsDF['label'].values))
